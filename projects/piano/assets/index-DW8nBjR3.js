...
`)+`
`+_);const N=A+y+f,R=A+_+d,L=i_(l,l.VERTEX_SHADER,N),z=i_(l,l.FRAGMENT_SHADER,R);l.attachShader(T,L),l.attachShader(T,z),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function F(V){if(r.debug.checkShaderErrors){const ie=l.getProgramInfoLog(T)||"",W=l.getShaderInfoLog(L)||"",oe=l.getShaderInfoLog(z)||"",ue=ie.trim(),B=W.trim(),H=oe.trim();let J=!0,Me=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,T,L,z);else{const Se=s_(l,L,"vertex"),O=s_(l,z,"fragment");wt("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
